...
uint64_t add12u_0EJ(uint64_t a, uint64_t b) {
  int wa[12];
  int wb[12];
  uint64_t y = 0;
  wa[0] = (a >> 0) & 0x01;
  ...
  y |=  (sig_73 & 0x01) << 0; // default output
  y |=  (sig_79 & 0x01) << 1; // default output
  y |=  (sig_70 & 0x01) << 2; // default output
  y |=  (sig_73 & 0x01) << 3; // default output
