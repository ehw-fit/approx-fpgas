...
uint32_t mul12u_2XA(uint16_t A, uint16_t B)
{
  ...
  P_ = (((C_11_2 & 1)<<1)|((C_11_3 & 1)<<2)|((C_11_4 & 1)<<3)|((C_11_5 & 1)<<4)|((C_11_6 & 1)<<5)|((C_11_7 & 1)<<6)|((C_11_8 & 1)<<7)|((C_11_9 & 1)<<8)|((C_11_10 & 1)<<9)) + (((S_11_2 & 1)<<0)|((S_11_3 & 1)<<1)|((S_11_4 & 1)<<2)|((S_11_5 & 1)<<3)|((S_11_6 & 1)<<4)|((S_11_7 & 1)<<5)|((S_11_8 & 1)<<6)|((S_11_9 & 1)<<7)|((S_11_10 & 1)<<8)|((S_11_11 & 1)<<9));
  S_12_1 = (P_ >> 0) & 1;
  S_12_2 = (P_ >> 1) & 1;
  S_12_3 = (P_ >> 2) & 1;
  S_12_4 = (P_ >> 3) & 1;
