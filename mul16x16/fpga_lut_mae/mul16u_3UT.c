...
uint64_t mult8_cgp14zr_wc7200_rcam(const uint64_t B,const uint64_t A)
{
...
uint32_t mul16u_3UT (uint16_t a, uint16_t b) {
    ...
    if(fillData) {
        for(int i = 0; i < 256; i++) {
            for(int j = 0; j < 256; j++) {
                cacheLL[i * 256 + j] = mult8_cgp14zr_wc7200_rcam(i, j);
