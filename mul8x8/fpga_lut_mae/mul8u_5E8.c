...
uint64_t mul8u_5E8(const uint64_t B,const uint64_t A)
{
   ...
   dout_95=((B >> 6)&1)&((A >> 3)&1);
   dout_96=((B >> 7)&1)&((A >> 3)&1);
   dout_103=((B >> 1)&1)&((A >> 3)&1);
   dout_107=dout_72^dout_91;
   dout_108=dout_72&dout_91;
   dout_109=dout_107&dout_20;
   dout_110=dout_107^dout_20;
