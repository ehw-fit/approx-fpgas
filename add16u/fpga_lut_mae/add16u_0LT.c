...
uint64_t add16u_0LT(uint64_t a, uint64_t b) {
  int wa[16];
  int wb[16];
  uint64_t y = 0;
  wa[0] = (a >> 0) & 0x01;
  ...
  y |=  (sig_101 & 0x01) << 6; // default output
  y |=  (wa[2] & 0x01) << 7; // default output
  y |=  (wb[14] & 0x01) << 8; // default output
  y |=  (sig_68 & 0x01) << 9; // default output
  y |=  (wb[5] & 0x01) << 10; // default output
